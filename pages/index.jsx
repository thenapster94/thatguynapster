        ...
        <div className="row home-details-container align-items-center">
          ...
          <div className="col-12 home-details text-left text-sm-center text-lg-left">
            <div className="col-lg-7 px-0">
              ...
              <p className="open-sans-font text-white">
                I'm a Ghanaian based front‑end developer focused on crafting clean & user‑friendly experiences, I am passionate about building excellent software that improves the lives of those around me.
              </p>
